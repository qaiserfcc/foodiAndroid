...
import com.hallyu.style.databinding.ItemCategoriesBinding
import com.hallyu.style.response.SubCategory


class ListCategoriesAdapter(private val onItemClicked: (SubCategory) -> Unit) : ListAdapter<SubCategory, ListCategoriesAdapter.ItemViewHolder>(
    DiffCallback
) {
    var selectedId = -1

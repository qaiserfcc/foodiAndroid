    ...
    class ItemViewHolder(
        ...
        fun bind(product: Product) {
            binding.apply {
                ...
                txtPrice.text = "${product.getPrice()} ${itemView.context.getString(R.string.currency)}"

                if (product.salePercent != null && product.salePercent > 0) {
                    txtPrice.text = "${product.getPreviousPrice()} ${itemView.context.getString(R.string.currency)}"
                    ...
                    txtSalePrice.text = "${product.getPrice()} ${itemView.context.getString(R.string.currency)}"

...
//            }
    ...
    fun getReview(idProduct: String) {
        ...
        compositeDisposable.add(apiService.getProductReviews(idProduct).subscribeOn(Schedulers.io())
...
//    }
    ...
    private fun setReviewForProduct(review: Review) {
        ...
        compositeDisposable.add(apiService.addReview(requestJson).subscribeOn(Schedulers.io())
            .observeOn(AndroidSchedulers.mainThread()).subscribe({ response ->
                Log.d(
                    "RatingViewModel",

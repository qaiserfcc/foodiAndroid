...
import com.hallyu.style.adapters.ListCategoriesAdapter
import com.hallyu.style.adapters.ListProductAdapter
import com.hallyu.style.core.BaseFragment
import com.hallyu.style.data.Product
import com.hallyu.style.databinding.FragmentCatalogBinding
...
import com.hallyu.style.utilities.BRAND_ID
import com.hallyu.style.utilities.BUNDLE_KEY_IS_FAVORITE
import com.hallyu.style.utilities.BUNDLE_KEY_MAX
import com.hallyu.style.utilities.BUNDLE_KEY_MIN
import com.hallyu.style.utilities.BUNDLE_KEY_NAME
import com.hallyu.style.utilities.BUNDLE_KEY_POSITION
import com.hallyu.style.utilities.GRIDVIEW_SPAN_COUNT_PRODUCT
import com.hallyu.style.utilities.NAME_CATEGORY
import com.hallyu.style.utilities.NAME_PRODUCT
...
//                            binding.appBarLayout.recyclerViewCategories.smoothScrollToPosition(index)
            ...
            newListProductLiveData.observe(viewLifecycleOwner) { data ->
                data?.let {
                    Log.d("TAG", "setUpObserve: listProductLiveData : page: $page size: ${it.pagination}")

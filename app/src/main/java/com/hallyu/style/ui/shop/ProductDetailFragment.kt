...
import com.hallyu.style.adapters.ImageProductAdapter
...
import com.hallyu.style.databinding.FragmentProductDetailBinding
import com.hallyu.style.ui.auth.AuthActivity
import com.hallyu.style.ui.favorite.FavoriteViewModel
import com.hallyu.style.ui.general.CartDialogFragment
        ...
        binding.apply {
            ...
            viewPagerImageProduct.apply {
                if (NetworkHelper.isNetworkAvailable(requireContext())) {
                    ...
                    val adapterImage = ImageProductAdapter(this@ProductDetailFragment, product.gallery,
                        fun(it: Int) {
                            touchImage(
                                product.gallery, it
                            )

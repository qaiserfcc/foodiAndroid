...
import com.bhub.foodi.FoodiApplication
    ...
    fun buildRetrofit(context: Context): ApiService {
        ...
        httpClient.addInterceptor(Interceptor { chain: Interceptor.Chain ->
            ...
            if (authTokenProvider.isLogged()) {
                ...
                Log.i(
                    "TAG",
                    "buildRetrofit: Authorization : Bearer token::: $${authTokenProvider.getAccessToken()}"
                )

            }
            requestBuilder.header("Accept", "application/json")
            requestBuilder.header("Language", "${FoodiApplication.lang}")
            Log.i(
                "TAG",
                "buildRetrofit: Accept : application/json, Language : ${FoodiApplication.lang}"
            )

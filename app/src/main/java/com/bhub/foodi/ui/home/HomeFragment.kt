...
import com.bhub.foodi.adapters.HomeBrandsAdapter
import com.bhub.foodi.adapters.HomeCategoriesAdapter
import com.bhub.foodi.adapters.ImageHomeAdapter
import com.bhub.foodi.adapters.ListHomeAdapter
...
//                toastMessage(getString(R.string.failed))
            ...
            homeLiveData.observe(viewLifecycleOwner) {
                ...
                if (it != null) {
                    ...
                    Toast.makeText(requireContext(), "Failed, please try again", Toast.LENGTH_SHORT)
                        .show()
                }
    ...
    private fun setSliders(sliders: List<Slider>) {
        binding.viewPagerHome2.apply {
            ...
            Log.d(
                ...
                "set adapter: debug::3 ::sliderUrls.size: ${sliderUrls.size}"
            )
